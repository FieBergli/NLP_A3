...
Input: She had trouble installing the solar panels on the roof, she didn't know much about electronics.
Output:
{
  "category": "Neutral",
  "subcategory": "Neutral",
...
Output:
{
  ...
  "problematic_phrase": "All men are bad multi-taskers.",
  "reason": "This suggests a lack of competence, purely based on gender",
  "neutral_rewrite": "Some people are bad multi-taskers.",
  "confidence": "High"
}
...
Input: As the mom Mary had to make breakfast for the family and clean the kitchen.
Output:
{
  "category": "Non-neutral",
...
Input: She spent a lot of time on her makeup because appearance is important for women.
Output:
{
  "category": "Non-neutral",
  "subcategory": "Gendered appearance stereotype",
  "problematic_phrase": "She spent a lot of time on her makeup because appearance is important for women.",
  "reason": "This connects behavior to feminine appearance expectations.",
  "neutral_rewrite": "She spent a lot of time on her makeup because appearance is important for her.",
  "confidence": "High"
}

Input: He likes to look muscular.
Output:
{
  "category": "Neutral",
  "subcategory": "Neutral",
  "problematic_phrase": "None",
  "reason": "This is an appearence statement only abbout one specific individual.",
  "neutral_rewrite": "No rewrite needed.",
  "confidence": "High"
}
...
Input: Women don't try hard in school because they are pretty and will marry a rich spouse.
Output:
{
  "category": "Non-neutral",
